...
function Friday() {
    ...
    useEffect(()=> {
      ...
      return (
        ...
        <thead style={{border: "1px solid rgb(0, 0, 0)", }}> {today.getDate()} <button className='btn btn-outline btn-sm '>Today</button></thead>    {yogaClasses.map((val, key) => {
            return (
        <tbody>
          {/* row 1 */}
